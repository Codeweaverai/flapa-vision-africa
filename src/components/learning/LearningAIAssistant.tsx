  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([{
        id: 'welcome-1',
        type: 'assistant',
        content: `Hi! I'm your Learning AI Assistant. I'm here to help you with your learning journey${courseName ? ` for "${courseName}"` : ''}. I can help you understand course content, explain concepts, review lesson materials, and answer questions about your courses. How can I assist you today?`,
        timestamp: new Date()
      }]);
    }
  }, [isOpen, messages.length, courseName]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      await supabase.from('ai_chat_history').insert({
        ...
        course_id: courseId,
        context_data: { courseId, courseName }
      });
          ...
          <Card className="h-full bg-white/95 backdrop-blur-sm border-0 shadow-xl">
            <CardHeader className="bg-gradient-to-r from-orange-500 to-purple-600 text-white rounded-t-lg">
              ...
              {courseName && (
                <p className="text-xs text-white/90">
                  Currently helping with: {courseName}
                </p>
              )}
            </CardHeader>
            ...
            <CardContent className="flex flex-col h-[calc(100%-80px)] p-4">
              ...
              <div className="flex gap-2">
                <Input
                  placeholder="Ask about your courses or lessons..."
                  value={inputMessage}
