...
const LearningAIAssistant: React.FC<LearningAIAssistantProps> = ({ 
  courseId, 
  courseName 
}) => {
  const { user } = useAuth();
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const welcomeMessage = {
        ...
        content: `Hello ${userName}! 👋 I'm Lumo AI, your Learning Assistant. I'm here to help you with your learning journey${courseName ? ` for "${courseName}"` : ''}. I can help you understand course content, explain concepts, review lesson materials, and answer questions about your courses. What would you like to learn today?`,
        timestamp: new Date(),
        formattedContent: {
          emoji: '👋',
          subject: `WELCOME TO LUMO AI, ${userName.toUpperCase()}!`,
          body: `I'm Lumo AI, your dedicated Learning Assistant. I'm here to help you with your learning journey${courseName ? ` for "${courseName}"` : ''}. I can help you understand course content, explain concepts, review lesson materials, and answer questions about your courses. What would you like to learn today?`
        }
      };
      setMessages([welcomeMessage]);
    }
  }, [isOpen, messages.length, courseName, userName]);
      ...
      await supabase.from('ai_chat_history').insert([
        {
          ...
          course_id: courseId,
          context_data: { courseId, courseName, userName }
        },
        {
          user_id: user.id,
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/90 font-medium">
                      Hello, {userName}! {courseName ? `• ${courseName}` : ''}
                    </p>
                  </div>
                </div>
                <Button
            ...
            <CardContent className="flex flex-col h-[calc(100%-80px)] p-0">
              ...
              <div className="p-4 border-t border-gray-100 bg-white">
                <div className="flex gap-2">
                  <Input
                    placeholder={`Ask Lumo AI about ${courseName ? courseName : 'your course'}...`}
                    value={inputMessage}
