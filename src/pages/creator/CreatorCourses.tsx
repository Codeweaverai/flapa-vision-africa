...
import { Edit, Trash2, Eye, Plus, BookOpen, Lock, Unlock } from 'lucide-react';
...
const CreatorCourses = () => {
  ...
  const handleTogglePublish = async (course: Course) => {
    ...
    if (updatedCourse) {
      ...
      toast.success(`${updatedCourse.title} has been ${updatedCourse.is_published ? 'published' : 'unpublished'}.`);
    }
  };
