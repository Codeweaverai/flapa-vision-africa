...
import { Calendar, MapPin, Users, Eye, Download, Clock, Ticket, Heart } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Manage your event registrations, view tickets, and stay updated with your upcoming experiences
              </p>
            </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex justify-center">
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-2xl">
                    <TabsList className="grid grid-cols-3 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-1 shadow-lg">
                      <TabsTrigger 
                        value="upcoming"
                      ...
                      >
                        ...
                        <span className="ml-2 bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-medium">
                          {events.filter(e => new Date(e.start_time) <= new Date() && new Date(e.end_time) >= new Date()).length}
                        </span>
                      </TabsTrigger>
                      <TabsTrigger 
                        value="completed"
                    ...
                    <TabsContent value="upcoming" className="mt-8">
                      {filteredEvents.length === 0 ? (
                        <div className="text-center py-12">
                          <div className="bg-gradient-to-r from-orange-100 to-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {filteredEvents.map((event) => {
                            ...
                            return (
                              <Card key={event.id} className="group relative overflow-hidden border-0 bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
                                {/* Event Status Ribbon */}
                                ...
                                <CardContent className="pt-0">
                                  <div className="flex gap-2">
                                    ...
                                    <Button 
                                      size="sm" 
                                      className="flex-1 bg-gradient-to-r from-orange-500 to-purple-600 hover:from-orange-600 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all"
                    ...
                    <TabsContent value="live" className="mt-8">
                      {filteredEvents.length === 0 ? (
                        <div className="text-center py-12">
                          <div className="bg-gradient-to-r from-green-100 to-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {filteredEvents.map((event) => {
                            ...
                            return (
                              <Card key={event.id} className="group relative overflow-hidden border-2 border-green-200 bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
                                {/* Live Badge */}
                                ...
                                <CardContent className="pt-0">
                                  <div className="flex gap-2">
                                    ...
                                    <Button 
                                      size="sm" 
                                      className="flex-1 bg-gradient-to-r from-green-500 to-purple-600 hover:from-green-600 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all"
                                      onClick={() => handleViewTickets(event)}
                                    >
                                      <Download className="h-4 w-4 mr-2" />
                                      Tickets
                    ...
                    <TabsContent value="completed" className="mt-8">
                      {filteredEvents.length === 0 ? (
                        <div className="text-center py-12">
                          <div className="bg-gradient-to-r from-purple-100 to-orange-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {filteredEvents.map((event) => {
                            ...
                            return (
                              <Card key={event.id} className="group relative overflow-hidden border-0 bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-500 grayscale hover:grayscale-0">
                                {/* Completed Badge */}
                                <div className={`absolute top-4 right-4 z-10 px-3 py-1 rounded-full text-xs font-semibold border ${eventStatus.color} backdrop-blur-sm`}>
                                  {eventStatus.icon} {eventStatus.label}
                                </div>
                                ...
                                <CardHeader className="pb-3">
                                  <CardTitle className="text-lg font-bold line-clamp-2 text-gray-600">
                                    {event.title}
                                  </CardTitle>
