            ...
            <QueryClientProvider client={queryClient}>
              <div className="App">
                <Routes>
                  ...
                  <Route path="/course/:courseId" element={<ProtectedRoute><CourseLearningPage /></ProtectedRoute>} />
                  <Route path="/course/:courseId/lesson/:lessonId" element={<ProtectedRoute><CoursePlayerPage /></ProtectedRoute>} />
